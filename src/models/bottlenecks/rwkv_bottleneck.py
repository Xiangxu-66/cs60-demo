...
def RUN_CUDA_OR_CPU(B, T, C, w, u, k, v):
    ...
    if k.is_cuda:
        try:
            ...
            if wkv_module is not None:
                # Use CUDA kernel
                if "32" in os.environ.get("RWKV_FLOAT_MODE", ""):
                ...
                if "32" in os.environ.get("RWKV_FLOAT_MODE", ""):
                    return y
                elif os.environ.get("RWKV_FLOAT_MODE") == "fp16":
                    return y.half()
